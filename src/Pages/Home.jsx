  ...
  return (
    <div className='bg-gray-900 h-full'>
      ...
      <section id='hero-section'>
        <div className='bg-gray-900 py-5 h-full'>


          <div className='relative;'>
            <div className='absolute top-[9rem] left-10   hidden md:block   gap-5 items-center justify-center bg-gray-900 w-auto border-2 border-white  rounded-3xl pt-3 pb-3  pl-2 pr-2 '>
              <div className=' text-white bg-transparent rounded-full  hover:bg-white hover:text-black p-[3px] my-2'> <Link to="#"><Atom size={20} /></Link> </div>
              <div className=' text-white bg-transparent rounded-full hover:bg-white hover:text-black p-[3px] my-2'><Link to="#"><UserRound size={20} /></Link></div>
              <div className=' text-white  bg-transparent rounded-full hover:bg-white hover:text-black  p-[3px] my-2'><Link to="#"><Code size={20} /></Link></div>
              <div className=' text-white bg-transparent rounded-full hover:bg-white hover:text-black  p-[3px] my-2'><Link to="#"><Monitor size={20} /></Link></div>
              <div className=' text-white bg-transparent rounded-full hover:bg-white hover:text-black  p-[3px] my-2'><Link to="#"><SquarePen size={20} /></Link></div>
              <div className=' text-white bg-transparent rounded-full hover:bg-white hover:text-black  p-[3px] my-2'><Link to="#"><Mail size={20} /></Link></div>
          ...
          <div className='container mx-auto grid md:grid-cols-2 lg:grid-cols-[450px_1fr_250px]   justify-items-center   items-center gap-4  '>
            <div className='border-t-green-400  justify-end text-center   border-l-green-400 border-4 border-r-0 border-b-0 rounded-tl-[134px] '>
              <div className='   flex flex-col justify-center items-center  gap-2 rounded-tl-[130px] rounded-br-[130px] border-4 pt-10 p-5 pr-5 w-full  '>
                ...
                <Link download={cv} className="mt-6 mb-5 flex items-center justify-center gap-2 bg-white text-gray-900 font-medium px-6 py-2 rounded-full shadow-md hover:bg-gray-200 transition">
            ...
            {/* Last Content */}
            <div className="flex flex-col justify-center  items-center  h-fit gap-10 py-10 w-fit bg-gray-950 rounded-[70px]">
      ...
      <section id='about_section' className=' h-full pb-10' >
        <div className='container mx-auto px-1 '>
          ...
          <div className='  grid md:grid-cols-[1fr_600px] justify-center gap-2 items-center pt-10'>
            <div className='flex flex-col items-center  justify-center'>
              <div className='mb-10'>
                <h2 className='border-2 border-green-400  rounded-tl-3xl rounded-br-3xl py-3 px-5 text-2xl text-white bg-gray-900 max-w-fit '> About Me</h2>
              </div>
              <div className='flex flex-col max-w-fit mb-0  p-5 gap-1 text-gray-200 bg-gray-900 rounded-3xl'>
