...
import { MapPin, Github, Linkedin, Twitter, Download, MessageCircle } from "lucide-react";
  ...
  return (
    <div className='bg-gray-800 py-5 h-full '>
      ...
      <div className='relative;'>
        ...
        <div className='text-center font-medium text-[5rem] text-green-300'> <h1>Developer</h1></div>


      </div>
      {/* Grids of hero section */}
      <div className='grid grid:[200px-1fr] md:grid-cols-2  items-center gap-4  '>
        <div className='border-t-green-400 ml-[80px] border-l-green-400 border-4 border-r-0 border-b-0 rounded-tl-[82px] max-w-fit'>
          <div className='   flex flex-col justify-center w-auto items-center gap-2 rounded-tl-[78px] rounded-br-[78px] border-4 pt-10 p-5 pr-5  max-w-fit '>
            ...
            <Link download={cv} className="mt-6  flex items-center justify-center gap-2 bg-white text-gray-800 font-medium px-6 py-2 rounded-full shadow-md hover:bg-gray-200 transition">
          ...
          <div className="flex flex-col max-w-fit gap-3 ">
            <div>
              ...
              <h1 className="text-6xl text-white font-bold text-start ">
                Hey  </h1>
              <h1 className="text-6xl text-white font-bold  text-start ">I’m <span className="text-6xl font-bold text-teal-400">Sinan</span>,</h1>
              <h1 className="text-6xl text-white font-bold ">Full-Stack Developer <Code2 className='text-green-400 ' /> </h1>
